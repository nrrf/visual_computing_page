...
function tri() {
  ...
  strokeWeight(3);
  noFill();
  triangle(col0 * ((img.width * upScale)/15) + ((img.width * upScale)/15) / 2, row0 * ((img.width * upScale)/15) + ((img.width * upScale)/15) / 2, col1 * ((img.width * upScale)/15) + ((img.width * upScale)/20) / 2, row1 * ((img.width * upScale)/15) + ((img.width * upScale)/15) / 2, col2 * ((img.width * upScale)/15) + ((img.width * upScale)/15) / 2, row2 * ((img.width * upScale)/15) + ((img.width * upScale)/15) / 2);
  pop();
}
...
function keyPressed() {
  ...
  if (key === 'r') {
    ...
    //quadrille.fill(row0,col0,color('cyan'))
    //quadrille.fill(row1,col1,color('cyan'))
    //quadrille.fill(row2,col2,color('cyan')) 
